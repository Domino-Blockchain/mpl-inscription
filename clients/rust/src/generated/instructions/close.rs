...
impl Close {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = CloseInstructionData::new().try_to_vec().unwrap();
...
pub struct CloseInstructionArgs {
...
pub struct CloseCpi<'a, 'b> {
    ...
    pub __args: CloseInstructionArgs,
}
